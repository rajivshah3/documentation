...
**In this quickstart, you learn the basics of IOTA development in Node.js, from setting up a development environment to connecting to a node.**
...
Continue learning with our [core JavaScript workshop](root://core/1.0/getting-started/get-started-js.md).
